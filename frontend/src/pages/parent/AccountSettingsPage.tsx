...
const ParentAccountSettingsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-12 px-4 sm:px-8 pt-8">
      {/* Header */}
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl border-2 border-blue-200 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-lg font-black text-gray-900">{user?.name || 'Parent'}</p>
          </div>
          <div>
            ...
            <form onSubmit={handleChangeUsername} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-blue-100 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all font-medium"
                  disabled={isLoading}
                />
              </div>
            ...
            <form onSubmit={handleChangePassword} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-blue-100 rounded-xl focus:outline-none focus:border-rose-500 focus:ring-2 focus:ring-rose-200 transition-all font-medium"
                  disabled={isLoading}
                />
              </div>
      ...
      <div className="bg-amber-50 rounded-3xl border-2 border-amber-200 p-8">
        ...
        <ul className="space-y-3 text-sm text-gray-700">
          ...
          <li className="flex gap-3">
            <span className="text-amber-600 font-bold">•</span>
            <span>Never share your password with anyone, including other family members</span>
          </li>
          <li className="flex gap-3">
            <span className="text-amber-600 font-bold">•</span>
