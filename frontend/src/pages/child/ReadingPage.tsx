...
const ReadingPage: React.FC = () => {
  ...
  const initViewer = useCallback(() => {
    ...
    if (!volumeId || !viewerContainerRef.current) return;
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      {viewerError && hasGoogleBook
                        ? 'The built-in viewer could not load this book. Open it on Google Books instead, then come back to log your pages.'
